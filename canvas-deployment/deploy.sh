...
# Canvas Course Shell Generator - EC2 Production Deployment Script
...
echo "📥 Cloning/updating application code..."
# Clone from GitHub repository
git clone https://github.com/yourusername/canvas-course-generator.git .
# Alternative: if you uploaded the files manually, uncomment the next line
# cp -r /tmp/canvas-deployment/* .
